...
const NAV_ITEMS = [
  ...
  // { label: 'Stock journalier', key: 'stock-journalier',  icon: PackageSearch   },
  { label: 'Mouvements',       key: 'mouvements',        icon: ArrowDownUp     },
  { label: 'Articles',         key: 'articles',          icon: Boxes           },
  { label: 'Dépôts',           key: 'depots',            icon: Warehouse       },
  // { label: 'Analyses',         key: 'analyses',          icon: BarChart3       },
  // { label: 'Alertes',          key: 'alertes',           icon: BellRing        },
  // { label: 'AI Prévisions',    key: 'previsions',        icon: BrainCircuit    },
  // { label: 'Rapports',         key: 'rapports',          icon: FileText        },
  // { label: 'Paramètres',       key: 'parametres',        icon: Settings        },
];
...
export default function Sidebar({ open, activePage, onNavigate }) {
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav className="flex-1 py-4 overflow-y-auto" style={{ colorScheme: 'light', scrollbarWidth: 'thin', scrollbarColor: '#e0e0e0 transparent' }}>
      ...
      <div className="px-5 py-4 shrink-0" style={{ borderTop: '1px solid #f0f0f0' }}>
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center text-xs font-bold" style={{ width: '2rem', height: '2rem', borderRadius: '50%', background: 'linear-gradient(135deg, #12a6e0, #01d63a)', color: '#ffffff', fontSize: '0.6875rem', flexShrink: 0 }}>AD</div>
          <div className="leading-tight min-w-0">
