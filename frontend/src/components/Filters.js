...
//         letterSpacing: '0.08em', color: '#12a6e0',
//       }}>
//         {Icon && <Icon size={11} />}
//         {label}
//       </label>
...
//             background: '#ffffff', border: '1px solid #e0e0e0', borderRadius: '0.5rem',
//             boxShadow: '0 4px 16px rgba(0,0,0,0.10)', zIndex: 1000,
...
//               style={{
//                 padding: '0.5rem 0.75rem', fontSize: '0.875rem', color: '#aaaaaa',
...
//         <span style={{
//           color: '#0d0c0c', fontSize: '0.75rem', fontWeight: 600,
...
// ── DateInput ────────────────────────────────────────────────────
function DateInput({ label, value, onChange, min, max, required }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
      <label style={{
        display: 'flex', alignItems: 'center', gap: '4px',
        fontSize: '11px', fontWeight: 600, textTransform: 'uppercase',
        letterSpacing: '0.08em', color: required ? '#e05c12' : '#12a6e0',
      }}>
        <CalendarDays size={11} />
        {label}
        {required && (
          <span style={{
            ...
            background: '#e05c12', borderRadius: '3px',
      ...
      <input
        ...
        style={{
          width: '100%', background: '#ffffff',
          border: `1px solid ${required && !value ? '#e05c12' : '#c5c5c5'}`,
          borderRadius: '0.5rem',
          padding: '0.625rem 0.75rem', fontSize: '0.875rem',
          color: value ? '#0d0c0c' : '#aaaaaa',
          outline: 'none',
          transition: 'border-color 0.15s, box-shadow 0.15s',
          colorScheme: 'light',
          boxSizing: 'border-box',
          boxShadow: required && !value ? '0 0 0 2px rgba(224,92,18,0.10)' : 'none',
        }}
        onFocus={e => { e.target.style.borderColor = '#12a6e0'; e.target.style.boxShadow = '0 0 0 3px rgba(18,166,224,0.12)'; }}
        onBlur={e => {
          e.target.style.borderColor = required && !value ? '#e05c12' : '#c5c5c5';
          e.target.style.boxShadow = required && !value ? '0 0 0 2px rgba(224,92,18,0.10)' : 'none';
        }}
      />
    </div>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
        {Icon && <Icon size={11} style={{ color: '#12a6e0' }} />}
        <span style={{
          fontSize: '10px', fontWeight: 700, textTransform: 'uppercase',
          letterSpacing: '0.1em', color: '#12a6e0', whiteSpace: 'nowrap',
        }}>
          {label}
        </span>
      </div>
      <div style={{ flex: 1, height: '1px', background: 'linear-gradient(to right, #daeef9, transparent)' }} />
    </div>
  );
}
...
export default function Filters({ onFilter, initialBase = '', initialDateDebut = '', initialDateFin = '' }) {
  ...
  const gridCols = isMobile ? '1fr' : isTablet ? 'repeat(2, 1fr)' : 'repeat(auto-fill, minmax(200px, 1fr))';
  const dateGridCols = isMobile ? '1fr' : 'repeat(2, 1fr)';
  ...
  return (
    <div style={{
      ...
      {/* ── EN-TÊTE : Titre + Dates ── */}
      <div style={{
        background: 'linear-gradient(135deg, #f0f9fe 0%, #e8f6fd 60%, #fef6f0 100%)',
        ...
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: '0 2px 8px rgba(18,166,224,0.30)',
            flexShrink: 0,
          }}>
            <SlidersHorizontal size={14} style={{ color: '#ffffff' }} />
          </div>
          <span style={{
            color: '#0d0c0c', fontSize: '0.8125rem', fontWeight: 700,
            letterSpacing: '0.06em', textTransform: 'uppercase',
          }}>
            Filtres de recherche
          </span>

          {/* Badge "Période obligatoire" */}
          <div style={{
            marginLeft: 'auto',
            display: 'flex', alignItems: 'center', gap: '5px',
            background: 'rgba(224,92,18,0.10)', border: '1px solid rgba(224,92,18,0.25)',
            borderRadius: '6px', padding: '3px 8px',
          }}>
            <CalendarDays size={10} style={{ color: '#e05c12' }} />
            <span style={{ fontSize: '10px', fontWeight: 600, color: '#e05c12', letterSpacing: '0.04em' }}>
              Période obligatoire
            </span>
          </div>
        </div>
        ...
        <div style={{
          display: 'grid',
          gridTemplateColumns: dateGridCols,
          gap: '0.875rem',
        }}>
          <DateInput
            label="Date début"
      ...
      {/* ── CORPS : Autres filtres ── */}
      <div style={{ padding: '1.25rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: gridCols, gap: '1rem' }}>

          <SectionDivider label="Base & Référentiel" icon={Database} />
          ...
          <SectionDivider label="Catalogue" icon={Layers} />
          ...
          <SectionDivider label="Article & Dépôt" icon={Package} />
