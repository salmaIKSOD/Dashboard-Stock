      ...
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#f0f0f0]">
        ...
        <button
          ...
          className="
            ...
            cursor-pointer transition-all duration-150
            hover:bg-[rgba(26,122,63,0.06)] hover:border-[rgba(26,122,63,0.55)] hover:shadow-[0_2px_8px_rgba(26,122,63,0.18)]
            active:scale-[0.98]
          "
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6z" stroke="#1a7a3f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            {paginated.map((row, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    {row[cols.catN1]
                      ? <span className="inline-block bg-[rgba(18,166,224,0.08)] text-[#0b7db0] text-[0.6875rem] px-2 py-0.5 rounded border border-[rgba(18,166,224,0.18)] whitespace-nowrap">
                          {row[cols.catN1]}
                        </span>
                      : <span className="text-[#e0e0e0]">—</span>
                    }
