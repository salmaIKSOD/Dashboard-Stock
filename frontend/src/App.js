      ...
      <div className="min-h-screen bg-[#f4f5f7]">
        ...
        >
          <Routes>
            ...
            <Route path="/dashboard/charts" element={<PageCharts />} />
            <Route path="/dashboard/trends" element={<PageTrends />} />
            <Route path="/dashboard/reports" element={<PageDashboardReports />} />
            <Route path="/dashboard/favorites" element={<PageFavorites />} />
