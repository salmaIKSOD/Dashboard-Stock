...
//     const sortedDates = Object.keys(entreesParJour).sort((a, b) => {
...
//     const sparkStock   = sortedDates.map(d => stockParJour[d]   || 0);
//     const sparkEntrees = sortedDates.map(d => entreesParJour[d] || 0);
//     const sparkSorties = sortedDates.map(d => sortiesParJour[d] || 0);
